...
//    - $Id: lambda_transport_equation.cc 2605 2014-08-15 03:36:44Z secanell $
//
//---------------------------------------------------------------------------
...
// ---             ---
template<int dim>
NAME::LambdaTransportEquation<dim>::LambdaTransportEquation(FuelCell::SystemManagement& system_management)
:
