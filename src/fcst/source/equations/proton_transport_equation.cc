...
//    - $Id: proton_transport_equation.cc 2605 2014-08-15 03:36:44Z secanell $
//
//---------------------------------------------------------------------------
...
template<int dim>
NAME::ProtonTransportEquation<dim>::ProtonTransportEquation(FuelCell::SystemManagement& system_management)
:
