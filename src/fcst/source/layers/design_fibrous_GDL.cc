    ...
    param.enter_subsection("Fuel cell data");
    {
        param.enter_subsection(name);
        {
            param.enter_subsection(concrete_name); //-- Transport for the anisotropic case:
            {
                ...
                param.declare_entry ("Electrical conductivity X",
                                     "100.", // [S/cm]
                                     Patterns::Double(0.),
                ...
                param.declare_entry ("Electrical conductivity Y",
                                     "100.", // [S/cm]
                                     Patterns::Double(0.),
                ...
                param.declare_entry ("Electrical conductivity Z",
                                     "100.", // [S/cm]
                                     Patterns::Double(0.),
        ...
        { 
            param.enter_subsection(concrete_name);
            {
                ...
                if (anisotropy == true)
                {
                    ...
                    sigma_e[0] = param.get_double("Electrical conductivity X");
                    
                    k_thermal[0] = param.get_double("Thermal conductivity X");
                    ...
                    sigma_e[1] = param.get_double("Electrical conductivity Y");
                    
                    k_thermal[1] = param.get_double("Thermal conductivity Y");
                    ...
                    sigma_e[2] = param.get_double("Electrical conductivity Z");
                    
                    k_thermal[2] = param.get_double("Thermal conductivity Z");
                ...
                else
                {
                    for (unsigned int i =0; i < porosity_th.size(); i++)
                    {
                        ...
                        sigma_e[i] = param.get_double("Electrical conductivity");
                        
                        k_thermal[i] = param.get_double("Thermal conductivity");
