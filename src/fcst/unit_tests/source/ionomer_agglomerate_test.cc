...
void  IonomerAgglomerateTest::testO2CurrentDensity()
{
    ...
    //Ionomer numerical : 206.25 match within 5%
    double expected = 260.25;
...
void  IonomerAgglomerateTest::testH2CurrentDensity()
{
    ...
    //Ionomer numerical : 206.25 match within 5%
    double expected = 206.25;
    double match = expected*0.05;
    TEST_ASSERT_DELTA_MSG(expected, current[0], match, "Current from model ionomer analytical does not match expected results!");
...
void IonomerAgglomerateTest::testO2CurrentDerivative(){
    ...
    double expDCurrentDO2 = 2600.0;     double diffDCurrentDO2    = expDCurrentDO2*0.05;
    double expDCurrentPhi_m = 7400.0;  double diffDCurrentPhi_m  = expDCurrentPhi_m*0.05;
    double expDCurrentPhi_s = -7400.0;  double diffDCurrentPhi_s  = -expDCurrentPhi_s*0.05; //Value has to be positive for comparison
