...
bool FcstTestSuite::run_tests()
{
    ...
    //ts.add(std::auto_ptr<Test::Suite>(new WaterPoreAgglomerateTest)); //in development
    ...
    ts.add(std::auto_ptr<Test::Suite>(new FuelCell::UnitTest::ApplicationStep8Test)); ///in development
