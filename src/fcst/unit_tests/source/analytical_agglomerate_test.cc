...
void AnalyticalAgglomerateTest::test02CurrentDerivative(){
    ...
    double expDCurrentPhi_m = 5700.0;  double diffDCurrentPhi_m  = expDCurrentPhi_m*0.05;
    double expDCurrentPhi_s = -5700.0;  double diffDCurrentPhi_s  = expDCurrentPhi_s*-0.05; //Difference has to be positive value
