...
//    - $Id: tafel_kinetics.h 2605 2014-08-15 03:36:44Z secanell $
//
//---------------------------------------------------------------------------
    ...
    namespace Kinetics
    {
        ...
        protected:
            ...
            virtual void init_kin_param()
            {
                ...
                Assert( reactants_map.size()>0, ExcMessage("Atleast one reactant should be set in the TafelKinetics object, using set_reactant_concentrations method.") );
