...
//    - $Id: base_kinetics.h 2605 2014-08-15 03:36:44Z secanell $
//
//---------------------------------------------------------------------------
...
namespace FuelCellShop
{
    namespace Kinetics
    {
        ...
        public:
            ...
            /**
             * Set reactant concentrations. The concentrations should be in \f$ mol/cm^3 \f$. It should be ensured that no molar fractions are set using this method.
             */
        ...
        protected:
            ...
            /**
             * A thresholding value of the GAS-LIQUID concentration of \f$ O_2 \f$ (cathode) or \f$ H_2 \f$ (anode) \f$ C^{text{GL}}_{O_2,H_2} \f$
             * by passing which the sink of \f$ O_2 \f$ (cathode) or \f$ H_2 \f$ (anode) becomes the source for these two gases.
             * The units of \f$ \text{th} \f$ are \f$ \frac{\text{mol}}{\text{cm}^3} \f$.
             * Typically, \f$ \text{th} \approx 10^{-10} - 10^{-8} \f$.
             * In this case, the modified Tafel reaction source term can be schematically written as \f$ \left( C^{text{GL}}_{O_2,H_2} - \text{th} \right)^{\gamma} A\left( \phi_s - \phi_m \right) \f$.
             * By setting the default value \f$ \text{th} = 0 \f$, you will cover the original Tafel equation.
             */
            double th;
