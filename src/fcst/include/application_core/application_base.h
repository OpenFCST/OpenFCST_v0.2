...
namespace FuelCell
{
    ...
    namespace ApplicationCore
    {
         ...
         * around another application. Wrapper applications are used to implement adaptive refinement, nonlinear 
         * and transient problems. Solving the aforementioned cases, generally involves solving a linear problem iteratively. 
        ...
        public:
            ...
            /**
             * Write the mesh in the format
             * specified by the ParameterHandler.
             *
             * Pure virtual.
             */
