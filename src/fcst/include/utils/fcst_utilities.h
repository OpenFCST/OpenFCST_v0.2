...
namespace FcstUtilities
{
     ...
     *
     * \note Currently, it is templated only to have \p KeyType as \p unsigned \p int and \p ValueType as \p double. But,
    ...
    /**
     * This function is a particular reimplementation
     * of the previous one.
     */
    template<>
