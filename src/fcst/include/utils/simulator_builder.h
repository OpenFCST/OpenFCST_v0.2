...
//    - $Id: simulator_builder.h 2605 2014-08-15 03:36:44Z secanell $
//
//---------------------------------------------------------------------------
...
protected:
    ...
    /**
     * Opens project specified by /prm file @param main_file
     * and outputs corresponding "main.xml" "data.xml" and "opt.xml" in current working directory.
     *
