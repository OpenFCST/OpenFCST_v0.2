...
# -- Write flags to /test/config.txt for CTestTestfile.cmake to read them
 ...
 file(WRITE ${CTEST_DASHBOARD_ROOT}/test/config.txt "List of current build flags:" "\n")
 file(APPEND ${CTEST_DASHBOARD_ROOT}/test/config.txt "PETScON" "\n") 					# Turn PETSc option on
 file(APPEND ${CTEST_DASHBOARD_ROOT}/test/config.txt "DAKOTAON" "\n") 					# Turn Dakota option on
